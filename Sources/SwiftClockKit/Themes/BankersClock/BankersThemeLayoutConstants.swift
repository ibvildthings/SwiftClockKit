...
struct BankersThemeLayoutConstants {
    static let borderWidthRatio: CGFloat = 0.035
    ...
    static let brandTextSizeRatio: CGFloat = 0.025
    static let brandTextOffsetRatio: CGFloat = 0.34
    ...
    struct Markers {
        ...
        static let hourHeightRatio: CGFloat = 0.028
        static let offsetRatio: CGFloat = -0.72
    ...
    struct HourHand {
        static let widthRatio: CGFloat = 0.009
        static let heightRatio: CGFloat = 0.82
        static let capsuleHeightRatio: CGFloat = 0.24
        static let distanceFromEndRatio: CGFloat = -0.2
    }
    
    struct MinuteHand {
        static let widthRatio: CGFloat = 0.009
        static let heightRatio: CGFloat = 1.09
        static let capsuleHeightRatio: CGFloat = 0.21
    ...
    struct SecondHand {
        ...
        static let centerPinSizeRatio: CGFloat = 0.11
